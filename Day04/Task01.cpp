...
int main() {
    ComplexClass c1(5.1,2.2);
    ComplexClass c2(3.0,2.0);

    cout<<"Arithmetic Operators :"<<endl<<"Binary: "<<endl;
    ...
    cout<< "(float)c1 result is :"<<(float)c1<<endl;;
    cout<< "(int) c2 result is :"<<(int)c2<<endl;
